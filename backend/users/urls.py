...
from .views import RegisterView, LoginView, UserProfileView, PartnerCodeView, ConnectPartnerView, DisconnectPartnerView, ProfileUpdateView, PrivacySettingsView
